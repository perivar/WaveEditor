...
{
	/// <summary>
	/// Control for viewing a spectrum analyser
	/// </summary>
	public sealed partial class CustomSpectrumAnalyzer : UserControl
	{
		#region Enums
		...
		ISpectrumPlayer soundPlayer;
		Bitmap offlineBitmap;
		readonly List<Rectangle> barShapes = new List<Rectangle>();
		readonly List<Rectangle> peakShapes = new List<Rectangle>();
		float[] channelData = new float[8192]; // store FFT results here
		float[] channelPeakData;
		double bandWidth = 1.0;
		double barWidth = 1;
		int maximumFrequencyIndex = 8191; // one less than fftDataSize
		int minimumFrequencyIndex;
		int[] barIndexMax;
		int[] barLogScaleIndexMax;
